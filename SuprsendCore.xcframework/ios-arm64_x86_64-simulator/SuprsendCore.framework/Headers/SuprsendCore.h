...
- (void)resetUnSubscribeNotification:(BOOL)unSubscribeNotification __attribute__((swift_name("reset(unSubscribeNotification:)")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("PreferredLanguage")))
@interface SuprsendCorePreferredLanguage : SuprsendCoreBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)preferredLanguage __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SuprsendCorePreferredLanguage *shared __attribute__((swift_name("shared")));
@property (readonly) NSDictionary<NSString *, NSString *> *values __attribute__((swift_name("values")));
@end;
...
- (void)setOnceKey:(NSString *)key value:(id)value __attribute__((swift_name("setOnce(key:value:)")));
- (void)setPreferredLanguageLanguageCode:(NSString *)languageCode __attribute__((swift_name("setPreferredLanguage(languageCode:)")));
- (void)setSmsMobile:(NSString *)mobile __attribute__((swift_name("setSms(mobile:)")));
- (void)setWhatsAppMobile:(NSString *)mobile __attribute__((swift_name("setWhatsApp(mobile:)")));
- (void)unSetKey:(NSString *)key __attribute__((swift_name("unSet(key:)")));
- (void)unSetKeys:(NSArray<NSString *> *)keys __attribute__((swift_name("unSet(keys:)")));
