...
@protocol SuprSendDeepLinkDelegate;
...
- (void)setDeepLinkDelegate:(id <SuprSendDeepLinkDelegate> _Nonnull)urlDelegate;
- (void)enableLogging;
...
SWIFT_PROTOCOL("_TtP11SuprSendSdk24SuprSendDeepLinkDelegate_")
@protocol SuprSendDeepLinkDelegate
- (BOOL)shouldHandleSuprSendDeepLink:(NSURL * _Nonnull)url SWIFT_WARN_UNUSED_RESULT;
@end
